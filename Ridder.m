...
%           Ridder(func,a,b,tol)
%
%           Uses an interval version of Ridder’s method to provide
...
%
function [x,Iter,t] =Ridder(func,x1,x2,tol)
Iter=0;
x=infsup(x1,x2)
f1=func(x1);
